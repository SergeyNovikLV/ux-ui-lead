    ...
    <article className="eleving mogo-case">
      ...
      <section className="case__section eleving-hero">
        <div className="case__wrap">
          ...
          {/* Role & scope — bullet list (Owned / Influenced / Decided) */}
          <div className="fleet-role__ledger mogo-hero__role-list">
            <div className="fleet-role__col">
              ...
              <div className="fleet-role__row"><span className="fleet-role__row-dot" aria-hidden /><span className="fleet-role__row-text">Flow architecture and step intent</span></div>
              <div className="fleet-role__row"><span className="fleet-role__row-dot" aria-hidden /><span className="fleet-role__row-text">UX specs: states, edge cases, acceptance criteria</span></div>
              <div className="fleet-role__row"><span className="fleet-role__row-dot" aria-hidden /><span className="fleet-role__row-text">Measurement baseline + post-release validation</span></div>
            </div>
            <div className="fleet-role__col">
              <h3 className="fleet-role__col-title">Influenced</h3>
              <div className="fleet-role__row"><span className="fleet-role__row-dot" aria-hidden /><span className="fleet-role__row-text">Scope sequencing with PO/Engineering</span></div>
              <div className="fleet-role__row"><span className="fleet-role__row-dot" aria-hidden /><span className="fleet-role__row-text">Release quality bar (definition of "done")</span></div>
              <div className="fleet-role__row"><span className="fleet-role__row-dot" aria-hidden /><span className="fleet-role__row-text">Stakeholder updates in decision-ready format</span></div>
            </div>
            <div className="fleet-role__col">
              <h3 className="fleet-role__col-title">Decided</h3>
              <div className="fleet-role__row"><span className="fleet-role__row-dot" aria-hidden /><span className="fleet-role__row-text">What to cut vs keep per step</span></div>
              <div className="fleet-role__row"><span className="fleet-role__row-dot" aria-hidden /><span className="fleet-role__row-text">CTA hierarchy + progressive disclosure rules</span></div>
              <div className="fleet-role__row"><span className="fleet-role__row-dot" aria-hidden /><span className="fleet-role__row-text">Checkpoints for success measurement</span></div>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="case__wrap">
          <div className="fleet-process__grid mogo-evidence__grid">
            ...
            <div className="fleet-process__card">
              <div className="fleet-process__card-method">USER SESSIONS</div>
              <div className="fleet-process__card-title">User sessions (2 segments)</div>
              <div className="fleet-process__card-rows">
                <div className="fleet-process__card-row fleet-process__card-row--first">
                  ...
                  <span className="fleet-process__card-value">Two focused sessions: new applicants vs returning users.</span>
                </div>
                <div className="fleet-process__card-row fleet-process__card-row--middle">
                  <span className="fleet-process__card-badge">SIGNAL</span>
                  <span className="fleet-process__card-value">Users stalled when steps felt repetitive, and the "next step" wasn't obvious.</span>
                </div>
                <div className="fleet-process__card-row fleet-process__card-row--last">
                  <span className="fleet-process__card-badge">DECISION</span>
                  <span className="fleet-process__card-value">Merge repeated decisions and make progress + "Next" explicit at every step.</span>
                </div>
              </div>
            </div>
            <div className="fleet-process__card">
              <div className="fleet-process__card-method">FEEDBACK ANALYSIS</div>
              <div className="fleet-process__card-title">Feedback analysis (reviews)</div>
              <div className="fleet-process__card-rows">
                <div className="fleet-process__card-row fleet-process__card-row--first">
                  <span className="fleet-process__card-badge">METHOD</span>
                  <span className="fleet-process__card-value">AI clustering of recurring themes + manual validation of top issues.</span>
                </div>
                <div className="fleet-process__card-row fleet-process__card-row--middle">
                  <span className="fleet-process__card-badge">SIGNAL</span>
                  <span className="fleet-process__card-value">Confusion clustered around "what happens next" and missing clarity in key moments.</span>
                </div>
                <div className="fleet-process__card-row fleet-process__card-row--last">
                  <span className="fleet-process__card-badge">DECISION</span>
                  <span className="fleet-process__card-value">Add clarity moments (what / why / next) and reduce cognitive load per step.</span>
                </div>
              </div>
            </div>
            <div className="fleet-process__card">
              <div className="fleet-process__card-method">BEHAVIORAL ANALYTICS</div>
              <div className="fleet-process__card-title">Behavioral analytics (GA4 + Clarity)</div>
              <div className="fleet-process__card-rows">
                <div className="fleet-process__card-row fleet-process__card-row--first">
                  <span className="fleet-process__card-badge">METHOD</span>
                  <span className="fleet-process__card-value">Funnel snapshots + session replays on entry and high-friction steps.</span>
                </div>
                <div className="fleet-process__card-row fleet-process__card-row--middle">
                  <span className="fleet-process__card-badge">SIGNAL</span>
                  <span className="fleet-process__card-value">Users missed primary actions when multiple UI blocks competed for attention.</span>
                </div>
                <div className="fleet-process__card-row fleet-process__card-row--last">
                  <span className="fleet-process__card-badge">DECISION</span>
                  <span className="fleet-process__card-value">Enforce one primary CTA per step and simplify hierarchy around it.</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="case__section mogo-impact">
        <div className="case__wrap">
          ...
          <p className="mogo-impact__body"><strong>Interpretation:</strong> Completion improved because the redesign reduced friction at every transition: fewer steps, clearer progression signals, and less visual competition on each screen.</p>
          <p className="mogo-impact__body"><strong>Drivers of the lift:</strong></p>
      ...
      <section className="case__section mogo-related">
        <div className="case__wrap">
          <div className="case__section-label">08 — RELATED WORK</div>
